...
export const easyLevels = [
  ...
  createLevel(15, 'easy', "Nhảy đúp", "Nhảy 2 cái liên tiếp?", {type:'motion', text:'Hop 2'}, {type:'motion', text:'Hop 1'}, {type:'motion', text:'Move Up 2'}, "Khối Hop + số 2."),
  createLevel(16, 'easy', "Dừng tay", "Dừng kịch bản lại (Stop)?", {type:'control', text:'Stop'}, {type:'control', text:'End'}, {type:'control', text:'Wait'}, "Hình bàn tay giơ lên."),
  createLevel(17, 'easy', "Giới thiệu", "Nhân vật nói bong bóng hội thoại?", {type:'looks', text:'Say'}, {type:'sound', text:'Pop'}, {type:'motion', text:'Right'}, "Dùng khối Say."),
  ...
  createLevel(20, 'easy', "Tiếng động", "Khối nào tạo ra âm thanh?", {type:'sound', text:'Pop'}, {type:'looks', text:'Show'}, {type:'looks', text:'Say'}, "Khối loa màu xanh lá."),
  ...
  createLevel(26, 'easy', "Siêu nhảy", "Bật nhảy thật cao (6)?", {type:'motion', text:'Hop 6'}, {type:'motion', text:'Hop 1'}, {type:'motion', text:'Move Up 6'}, "Hop và số 6."),
  ...
  createLevel(38, 'easy', "Lặp 4", "Lặp lại hành động 4 lần?", {type:'control', text:'Repeat 4'}, {type:'control', text:'Forever'}, {type:'control', text:'End'}, "Vòng lặp có số 4."),
  createLevel(39, 'easy', "Mãi mãi", "Lặp lại hành động vĩnh viễn?", {type:'control', text:'Forever'}, {type:'control', text:'Repeat'}, {type:'control', text:'End'}, "Vòng lặp kín."),
  createLevel(40, 'easy', "Kết thúc", "Khối đỏ dùng để kết thúc hoàn toàn?", {type:'control', text:'End'}, {type:'control', text:'Stop'}, {type:'control', text:'Forever'}, "Khối đỏ trơn."),

  // --- NHÓM 5: ÔN TẬP TỔNG HỢP (41-50) ---
  createLevel(41, 'easy', "Lên 10", "Đi lên phía trên 10 bước?", {type:'motion', text:'Move Up 10'}, {type:'motion', text:'Move Down 10'}, {type:'motion', text:'Move Up 1'}, "Lên và số 10."),
  createLevel(42, 'easy', "Nhảy thấp", "Nhảy thấp (chỉ 2 nấc)?", {type:'motion', text:'Hop 2'}, {type:'motion', text:'Hop 10'}, {type:'motion', text:'Move Up 2'}, "Hop và số 2."),
  ...
  createLevel(44, 'easy', "Hiện hình", "Lệnh làm nhân vật hiện ra?", {type:'looks', text:'Show'}, {type:'looks', text:'Hide'}, {type:'looks', text:'Say'}, "Hình người rõ."),
  createLevel(45, 'easy', "Thu và phát âm thanh", "Phát âm thanh (Play Sound)?", {type:'sound', text:'Play Sound'}, {type:'motion', text:'Hop'}, {type:'control', text:'Wait'}, "Khối loa."),
  ...
  createLevel(50, 'easy', "Hoàn tất", "Khối đỏ đóng lại kịch bản?", {type:'control', text:'End'}, {type:'looks', text:'Hide'}, {type:'sound', text:'Pop'}, "Khối đỏ.")
];